...
| ApexFit   | Comprehensive management of small gyms and independent trainers                                                       | Laravel, MariaDB, Tailwind          | ![HLD](https://img.shields.io/badge/status-HLD-orange)      | <a href="https://apexfit.app" target="_blank" rel="noopener noreferrer">apexfit.app</a> |
| Tepuy     | Python web framework inspired by Laravel — cloud-native, portable across traditional server/Kubernetes/serverless    | Python                              | ![DEV](https://img.shields.io/badge/status-DEV-blue)        | _(private repo)_                                                                         |
| MediMap   | Multi-tenant SaaS platform (backoffice, API & client portal)                                                          | Laravel, React, PostgreSQL, Kubernetes | ![MVP](https://img.shields.io/badge/status-MVP-success)  | <a href="https://medimap.cl" target="_blank" rel="noopener noreferrer">medimap.cl</a>   |
